...
docker pull tbert31/new-api-gateway:latest
docker pull tbert31/new-product-service:latest
docker pull tbert31/new-order-service:latest
docker pull tbert31/new-inventory-service:latest
docker pull tbert31/new-notification-service:latest
...
kind load docker-image -n microservices tbert31/new-api-gateway:latest
kind load docker-image -n microservices tbert31/new-product-service:latest
kind load docker-image -n microservices tbert31/new-order-service:latest
kind load docker-image -n microservices tbert31/new-inventory-service:latest
kind load docker-image -n microservices tbert31/new-notification-service:latest